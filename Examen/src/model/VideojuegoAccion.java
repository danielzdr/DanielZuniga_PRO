...
public class VideojuegoAccion extends Videojuego implements Descargable{
    ...
    public VideojuegoAccion(String titulo , String desarrollador , String clasificacionEdad , int anoLanzamiento , double precio , int nivelViolencia , boolean modoMultijugador , double tamanioGB) {
