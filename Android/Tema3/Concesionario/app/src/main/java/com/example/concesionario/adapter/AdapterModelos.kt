...
class AdapterModelos(var lista: ArrayList<Vehiculo>, var contexto: Context): BaseAdapter() {
    ...
    //retorna el numero de elementos que se pintaran en le spinner
    ...
    override fun getView(
        ...
        val imaggeModelo: ImageView=view.findViewById(R.id.itemModelo)
        ...
        imaggeModelo.setImageResource(modelo.imagen)
